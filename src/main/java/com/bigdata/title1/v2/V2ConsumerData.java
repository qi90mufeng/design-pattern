...
public class V2ConsumerData {
    private static final int total = 1000; //文件数
    private static final String basePackage = "D:/temp2/";
...
//        消费了多少条数据2: 9984868
    ...
    private static void consumer(int i){
        ...
        File file = new File(basePackage + "a/" + i + ".txt");
        ...
        //写入文件
        File fileC = new File(basePackage + "c/" + i + ".txt");
        //
        File fileB = new File(basePackage + "b/" + i + ".txt");
